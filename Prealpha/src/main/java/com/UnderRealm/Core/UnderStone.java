...
public class UnderStone extends UnderRealmBaseBlock {
	...
	public boolean removedByPlayer(World world, EntityPlayer player, int x, int y, int z, boolean willHarvest)
    {
    	...
    	if (meta == 3)
    	{
    		...
    		else
    		{
    			...
    			//return world.setBlock(x, y, z, Blocks.lava,0,3);
    			return world.setBlock(x, y, z, Blocks.lava);
    		}
    	}
    	else
    	{
	...
	public void getSubBlocks(Item p_149666_1_, CreativeTabs p_149666_2_, List par3List)
    {
		...
		{
			par3List.add(new ItemStack(p_149666_1_, 1, i));
		}
    ...
    {
		this.iconArray = new IIcon[UnderStoneTypeCount];
