...
public class UnderRealm_Shared {
	...
	public static Optional<? extends Block> Wither_Water = Optional.absent();		//Almost entirely implemented, maybe custom debuff instead of hunger to prevent regen.
	...
	public static Optional<? extends Block> Crystals     = Optional.absent();   	//These need to drop shards and have a chance to spawn a curtain monster.
	...
	public static Optional<? extends Item> FadingPendant = Optional.absent();
}
