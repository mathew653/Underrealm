...
public class UnderRealmChunkProvider extends ChunkProviderHell {
	...
	public UnderRealmChunkProvider(World par1World, long par2) {
		...
		this.WitherWaterLakeGenerator = new WorldGenLakes(FluidID);
		
		this.spikeGen = new UnderRealmGenSpikes(StoneID);
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        short[] abyte = new short[32768]; // Block IDs.
        
        this.biomesForGeneration = this.worldObj.getWorldChunkManager().loadBlockGeneratorData(this.biomesForGeneration, par1 * 16, par2 * 16, 16, 16);
        
        this.generateUnderRealmTerrain(par1, par2, abyte, mbyte);
        //this.EXreplaceBlocksForBiome(par1, par2, abyte, this.biomesForGeneration);
        this.WriteBedRock(par1, par2, abyte);
